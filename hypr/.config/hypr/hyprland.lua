...
hl.bind(mainMod .. " + CTRL +" ..nav_right, hl.dsp.window.resize({ x = 10, y = 0, relative = true}), { repeating = true })
hl.bind(mainMod .. " + CTRL +" ..nav_left, hl.dsp.window.resize({ x = -10, y = 0, relative = true}), { repeating = true })
hl.bind(mainMod .. " + CTRL +" ..nav_down, hl.dsp.window.resize({ x = 0, y = 10, relative = true}), { repeating = true })
